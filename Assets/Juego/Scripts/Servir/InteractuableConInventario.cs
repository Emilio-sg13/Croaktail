...
public class InteractuableConInventario : MonoBehaviour
{
    ...
    IEnumerator EsperarYActuar()
    {
        ...
        switch (tag)
        {
            ...
            case "barra":
                {
                    // Caso "barra": se puede recoger o depositar, seg鷑 si hay un item depositado.
                    ...
                    if (spriteRenderer.sprite != null)
                    {
                        ...
                        if (pickedItem != null)
                        {
                            // Se intenta a馻dir el item al inventario sin depender del slot seleccionado.
                            bool added = inventario.TryAddItem(pickedItem);
                            if (added)
                            {
                                Debug.Log("Item recogido desde la barra y a馻dido al inventario.");
                                // Vaciar la barra para permitir nuevos dep髎itos.
                    ...
                    {
                        // Si la barra est?vac韆, depositar el item seleccionado, solo si existe.
                        Sprite selectedSprite = inventario.slots[selectedIndex].sprite;
                        if (selectedSprite != null)
                        {
